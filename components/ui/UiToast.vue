    ...
    <div class="fixed top-6 right-6 z-[9999] flex flex-col gap-3 pointer-events-none">
      <TransitionGroup name="toast" tag="div" class="flex flex-col gap-3">
        <div
          ...
          :key="toast.id"
          class="pointer-events-auto relative flex items-start gap-3 min-w-[300px] max-w-sm rounded-xl border px-4 py-3 bg-base-100 text-base-content shadow-xl backdrop-blur"
        ...
        >
          ...
          <!-- Icon -->
          <div class="mt-0.5" :class="iconByTypeColor(toast.type)">
